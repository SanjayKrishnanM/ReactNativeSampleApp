...
module.exports = {
    ...
    showConversations: function(conversationOptions) {
        console.log("show conversation in wrapper");
    ...
    showConversationWithReferenceID: function(topicName, conversationReferenceId) {
        RNFreshchatSdk.showConversation(topicName, conversationReferenceId);
    },
    ...
    setUserProperties: function(userProperties, errorCallback) {
        console.log("Please provide user properties to update the user - In wrapper")
        RNFreshchatSdk.setUserProperties(userProperties, errorCallback); 
    },

    setBotVariables: function(variables, botSpecificVariables) {
        console.log("setBotVariables - In wrapper")
        RNFreshchatSdk.setBotVariables(variables, botSpecificVariables);
    },
